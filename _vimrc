...
let g:git_command = 'C:\\Users\\5016023208\\AppData\\Local\\Programs\\Git\\bin\\git.exe'
...
set sw=4
set si
cd C:\Users\5016023208\Desktop\Mongo\test
...
" Set the font for gVim (GUI version of Vim) on Windows
if has("gui_running")
